            ...
            steps {
                dir('Terraform') {                
                    ...
                    withAWS(credentials:'AWS', region: 'us-east-1') {
                            sh 'terraform init -backend-config=bucket=maciej-plewko-panda-devops-core-17'
                            sh 'terraform apply -auto-approve -var bucket_name=maciej-plewko-panda-devops-core-17'
